...
num_solutions = 2 # A solution or a network can be used interchangeably.
...
sol_per_pop = 2
num_genes = len(population_vectors[0])
...
mutation_percent_genes = 1 # Percentage of genes to mutate. This parameter has no action if the parameter mutation_num_genes exists.
